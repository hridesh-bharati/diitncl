const r="https://diitnclserver.onrender.com",n=async(e,t,o)=>{try{const i=await fetch(`${r}/api/send-mail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:e,subject:t,html:o})}),d=await i.json();return i.ok}catch{return!1}},a=e=>`
...
`,c=(e,t)=>{const o=t.duration||1,i=`${o} ${o<=1?"Hour":"Hours"}`;return`
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 20px auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08); background-color: #fff;">
...
`;export{l as a,a as b,s as c,f as d,p as e,c as f,n as s};
