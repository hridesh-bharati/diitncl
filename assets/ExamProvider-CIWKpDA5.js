import{C as P,e as u,d as i,D as A,c as g,E as v,q as w,z as F,o as I,G as y,g as E,w as N,u as T}from"./vendor-firebase-D17fb6t0.js";import{r as f,j as O}from"./vendor-core-DhK4p7pv.js";import{s as k}from"./courseData-CeKRB8nL.js";const L={"ADCA+":{duration:18,monthly:800,adm:600},ADCA:{duration:15,monthly:700,adm:500},DCA:{duration:12,monthly:700,adm:500},DCAA:{duration:6,monthly:700,adm:500},CCC:{duration:3,monthly:1e3,adm:500}},j=(e,t=[])=>{const d=e?.toUpperCase()||"",a=L[d]||{duration:6,monthly:700,adm:500},o=a.duration*a.monthly+a.adm,c=t.reduce((h,b)=>h+Number(b.amount||0),0);return{...a,netFee:o,totalPaid:c,balance:o-c}},_=async(e,t)=>{await A(g(i,"admissions",e,"payments"),{...t,amount:Number(t.amount),createdAt:v()})},B=async(e,t)=>{window.confirm("Delete this payment permanently?")&&await P(u(i,"admissions",e,"payments",t))},U=e=>{const t=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],d=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],a=o=>o<20?t[o]:o<100?d[Math.floor(o/10)]+(o%10!==0?" "+t[o%10]:""):o<1e3?t[Math.floor(o/100)]+" Hundred"+(o%100!==0?" "+a(o%100):""):o;return e>0?a(e):"Zero"},C=(e,t,d,a=!1)=>{const o=a?"OFFICIAL FEE RECEIPT":"STUDENT FEE LEDGER / STATEMENT";return`
  <html>
  <head>
  ...
  <body onload="window.print(); setTimeout(()=>window.close(), 1000);">
    <div className="page">
        ...
        <tbody>
          ${t.map((c,h)=>`
            <tr className="${h%2===0?"":"even"}">
              ...
              <td className="text-right">₹ ${c.amount}.00</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
      ...
      <div className="declaration">
        <p><b>Amount in Words:</b> ${U(a?t[0].amount:d.totalPaid)} Rupees Only.</p>
  ...
  </html>`},q=(e,t,d)=>{const a=window.open("","_blank");a.document.write(C(e,t,d,!1)),a.document.close()},H=(e,t,d)=>{const a=window.open("","_blank");a.document.write(C(e,[t],d,!0)),a.document.close()},S=f.createContext(),W=()=>f.useContext(S),z=k.map(e=>e.name),X=({children:e})=>{const[t,d]=f.useState([]),[a,o]=f.useState(!0);f.useEffect(()=>{const n=w(g(i,"exams"),F("createdAt","desc"));return I(n,s=>{d(s.docs.map(r=>({id:r.id,...r.data()}))),o(!1)})},[]);const c=async n=>{try{return(await A(g(i,"exams"),{...n,status:"Draft",isLive:!1,resultsPublished:!1,createdAt:v()})).id}catch{return null}},h=async(n,s)=>{try{const r=y(i);return(await E(w(g(i,"examQuestions"),N("examId","==",n)))).forEach(l=>r.delete(l.ref)),s.forEach(l=>{const p=u(g(i,"examQuestions"));r.set(p,{...l,examId:n})}),r.update(u(i,"exams",n),{status:"Ready",totalQuestions:s.length}),await r.commit(),!0}catch{return!1}},b=async(n,s)=>{try{const r=y(i);return s.forEach(m=>{const l=`${m}_${n}`,p=u(i,"studentExams",l);r.set(p,{studentId:m,examId:n,status:"Pending",score:0,assignedAt:v()})}),await r.commit(),!0}catch{return!1}},D=async(n,s,r,m)=>{try{const l=u(i,"studentExams",`${n}_${s}`);let p=0;return m.forEach(x=>{r[x.id]===x.correctAnswer&&(p+=Number(x.marks||1))}),await T(l,{status:"Completed",answers:r,score:p,completedAt:new Date}),{success:!0,score:p}}catch(l){return{success:!1,error:l.message}}},R=async n=>{if(window.confirm("PERMANENT DELETE: Are you sure? This will delete the exam and all related questions!"))try{const s=y(i);return(await E(w(g(i,"examQuestions"),N("examId","==",n)))).docs.forEach(m=>s.delete(m.ref)),s.delete(u(i,"exams",n)),await s.commit(),!0}catch{return!1}},$=async(n,s)=>await T(u(i,"exams",n),{isLive:!s});return O.jsx(S.Provider,{value:{exams:t,courses:z,loading:a,createExam:c,addQuestions:h,assignToStudents:b,submitExam:D,toggleExamLive:$,deleteExam:R},children:e})};export{L as C,X as E,_ as a,q as b,B as d,j as g,H as p,W as u};
