const a="/api/send-mail",p=async(t,e,o)=>{try{return(await(await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:t,subject:e,html:o})})).json().catch(()=>({success:!1}))).success}catch{return!1}},s=t=>`
...
`,x=(t,e)=>{const o=e.duration||1,i=`${o} ${o<=1?"Hour":"Hours"}`,d=e.date||"As per Schedule";let r=e.startTime;try{e.startTime&&!e.startTime.includes("M")&&(r=new Date(`2000-01-01T${e.startTime}`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0}))}catch{r=e.startTime}const n=e.endTime||"As per Schedule";return`
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 20px auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08); background-color: #fff;">
      ...
      <div style="background-color: #fff5f6; border: 1px solid #fed7d7; border-left: 6px solid #fc0038; padding: 25px; border-radius: 8px; margin: 25px 0;">
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 10px 0; color: #333; font-weight: 600;">${d}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; color: #777; font-size: 14px;">Log-in Time</td>
            <td style="padding: 10px 0; color: #fc0038; font-weight: 800; font-size: 17px;">${r}</td>
          </tr>
          <tr>
...
`;export{c as a,s as b,f as c,h as d,g as e,y as f,x as g,p as s};
