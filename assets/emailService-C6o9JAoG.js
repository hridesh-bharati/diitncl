const l="/api/send-mail",p="/api/send-push",c=async(t,e,o,i="/student/dashboard")=>{if(!t?.pushSubscription)return!1;try{return(await(await fetch(p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({subscription:JSON.parse(t.pushSubscription),title:e,body:o,url:`https://www.drishteeindia.com${i}`})})).json().catch(()=>({success:!1}))).success}catch{return!1}},f=async(t,e,o,i=null,r="",d="",n="")=>{try{const s=await(await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:t,subject:e,html:o})})).json().catch(()=>({success:!1}));return i?.pushSubscription&&r&&c(i,r,d,n),s.success}catch{return!1}},g=t=>`
...
`;export{x as a,g as b,b as c,u as d,h as e,y as f,f as s};
