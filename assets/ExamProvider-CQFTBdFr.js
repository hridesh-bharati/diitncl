import{h as P,d as u,b as i,n as C,f as g,s as v,r as b,q as w,o as F,g as I,j as O,E as y,v as E,w as T,a as A}from"./index-B0hW452e.js";import{s as k}from"./courseData-CeKRB8nL.js";const L={"ADCA+":{duration:18,monthly:800,adm:600},ADCA:{duration:15,monthly:700,adm:500},DCA:{duration:12,monthly:700,adm:500},DCAA:{duration:6,monthly:700,adm:500},CCC:{duration:3,monthly:1e3,adm:500}},j=(t,e=[])=>{const d=t?.toUpperCase()||"",a=L[d]||{duration:6,monthly:700,adm:500},o=a.duration*a.monthly+a.adm,c=e.reduce((h,f)=>h+Number(f.amount||0),0);return{...a,netFee:o,totalPaid:c,balance:o-c}},G=async(t,e)=>{await C(g(i,"admissions",t,"payments"),{...e,amount:Number(e.amount),createdAt:v()})},_=async(t,e)=>{window.confirm("Delete this payment permanently?")&&await P(u(i,"admissions",t,"payments",e))},U=t=>{const e=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],d=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],a=o=>o<20?e[o]:o<100?d[Math.floor(o/10)]+(o%10!==0?" "+e[o%10]:""):o<1e3?e[Math.floor(o/100)]+" Hundred"+(o%100!==0?" "+a(o%100):""):o;return t>0?a(t):"Zero"},S=(t,e,d,a=!1)=>{const o=a?"OFFICIAL FEE RECEIPT":"STUDENT FEE LEDGER / STATEMENT";return`
  <html>
  <head>
  ...
  <body onload="window.print(); setTimeout(()=>window.close(), 1000);">
    <div class="page">
      ...
      <div class="declaration">
        <p><b>Amount in Words:</b> ${U(a?e[0].amount:d.totalPaid)} Rupees Only.</p>
  ...
  </html>`},B=(t,e,d)=>{const a=window.open("","_blank");a.document.write(S(t,e,d,!1)),a.document.close()},q=(t,e,d)=>{const a=window.open("","_blank");a.document.write(S(t,[e],d,!0)),a.document.close()},D=b.createContext(),H=()=>b.useContext(D),z=k.map(t=>t.name),W=({children:t})=>{const[e,d]=b.useState([]),[a,o]=b.useState(!0);b.useEffect(()=>{const n=w(g(i,"exams"),F("createdAt","desc"));return I(n,s=>{d(s.docs.map(r=>({id:r.id,...r.data()}))),o(!1)})},[]);const c=async n=>{try{return(await C(g(i,"exams"),{...n,status:"Draft",isLive:!1,resultsPublished:!1,createdAt:v()})).id}catch{return null}},h=async(n,s)=>{try{const r=y(i);return(await E(w(g(i,"examQuestions"),T("examId","==",n)))).forEach(l=>r.delete(l.ref)),s.forEach(l=>{const m=u(g(i,"examQuestions"));r.set(m,{...l,examId:n})}),r.update(u(i,"exams",n),{status:"Ready",totalQuestions:s.length}),await r.commit(),!0}catch{return!1}},f=async(n,s)=>{try{const r=y(i);return s.forEach(p=>{const l=`${p}_${n}`,m=u(i,"studentExams",l);r.set(m,{studentId:p,examId:n,status:"Pending",score:0,assignedAt:v()})}),await r.commit(),!0}catch{return!1}},N=async(n,s,r,p)=>{try{const l=u(i,"studentExams",`${n}_${s}`);let m=0;return p.forEach(x=>{r[x.id]===x.correctAnswer&&(m+=Number(x.marks||1))}),await A(l,{status:"Completed",answers:r,score:m,completedAt:new Date}),{success:!0,score:m}}catch(l){return{success:!1,error:l.message}}},R=async n=>{if(window.confirm("PERMANENT DELETE: Are you sure? This will delete the exam and all related questions!"))try{const s=y(i);return(await E(w(g(i,"examQuestions"),T("examId","==",n)))).docs.forEach(p=>s.delete(p.ref)),s.delete(u(i,"exams",n)),await s.commit(),!0}catch{return!1}},$=async(n,s)=>await A(u(i,"exams",n),{isLive:!s});return O.jsx(D.Provider,{value:{exams:e,courses:z,loading:a,createExam:c,addQuestions:h,assignToStudents:f,submitExam:N,toggleExamLive:$,deleteExam:R},children:t})};export{L as C,W as E,G as a,B as b,_ as d,j as g,q as p,H as u};
