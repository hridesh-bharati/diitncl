const r="https://diitnclserver.onrender.com/api/send-mail",n=async(e,t,o)=>{try{return(await(await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:e,subject:t,html:o})})).json()).success}catch{return!1}},a=e=>`
