const r="https://diitnclserver.onrender.com/api/send-mail",d=async(e,t,o)=>{try{return(await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:e,subject:t,html:o})})).ok}catch{return!1}},n=e=>`
...
`,s=(e,t)=>{const o=t.duration||1,i=`${o} ${o<=1?"Hour":"Hours"}`;return`
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 20px auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08); background-color: #fff;">
...
`;export{a,n as b,p as c,f as d,l as e,s as f,d as s};
