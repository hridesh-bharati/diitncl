import{R as s,r,j as t}from"./vendor-core-CT7l4TBI.js";function a(){const[o,i]=r.useState(!1);if(r.useEffect(()=>{const e=()=>i(window.scrollY>300);return window.addEventListener("scroll",e,{passive:!0}),()=>window.removeEventListener("scroll",e)},[]),!o)return null;const n={bottom:"90px",right:"20px",zIndex:9999,width:"50px",height:"50px",backgroundColor:"#0a2885",transition:"0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)"};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
