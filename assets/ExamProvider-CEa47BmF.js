import{h as P,d as u,b as i,n as A,f as g,s as v,r as b,q as w,o as F,g as I,j as O,E as y,v as E,w as N,a as T}from"./index-BeF5W8_u.js";import{s as k}from"./courseData-CeKRB8nL.js";const L={"ADCA+":{duration:18,monthly:800,adm:600},ADCA:{duration:15,monthly:700,adm:500},DCA:{duration:12,monthly:700,adm:500},DCAA:{duration:6,monthly:700,adm:500},CCC:{duration:3,monthly:1e3,adm:500}},j=(e,t=[])=>{const d=e?.toUpperCase()||"",a=L[d]||{duration:6,monthly:700,adm:500},o=a.duration*a.monthly+a.adm,c=t.reduce((h,f)=>h+Number(f.amount||0),0);return{...a,netFee:o,totalPaid:c,balance:o-c}},G=async(e,t)=>{await A(g(i,"admissions",e,"payments"),{...t,amount:Number(t.amount),createdAt:v()})},_=async(e,t)=>{window.confirm("Delete this payment permanently?")&&await P(u(i,"admissions",e,"payments",t))},U=e=>{const t=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],d=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],a=o=>o<20?t[o]:o<100?d[Math.floor(o/10)]+(o%10!==0?" "+t[o%10]:""):o<1e3?t[Math.floor(o/100)]+" Hundred"+(o%100!==0?" "+a(o%100):""):o;return e>0?a(e):"Zero"},C=(e,t,d,a=!1)=>{const o=a?"OFFICIAL FEE RECEIPT":"STUDENT FEE LEDGER / STATEMENT";return`
  <html>
  <head>
