          ...
          <div className="col-lg-4">
            <div className="brand-card-glass">
              ...
              <p className="brand-text-modern">
                Crafting digital careers since 2008. We don't just teach code, we build professionals for the global tech ecosystem.
              </p>
          ...
          <div className="col-lg-4">
            <div className="nav-card-glass">
              ...
              <div className="footer-nav-grid">
                ...
                <Link to="/Placement">Careers</Link>
                <Link to="/Verify-Certificate">Verify ID</Link>
        ...
        <div className="footer-bottom-glass mx-0 px-0">
          <div className="row align-items-center">
            <div className="col-md-6">
              <p className="copy-text">© 2026 <b>Drishtee Education</b>. Built with ❤️ for Students.</p>
            </div>
            <div className="col-md-6 text-md-end">
              <div className="creator-badge">
                <span className="me-2">Project by</span>
                <span className="creator-name">Hridesh Bharati</span>
              </div>
              {/* ================= BOTTOM SVG ================= */}
