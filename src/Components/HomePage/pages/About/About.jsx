...
const About = () => {
  return (
  <div className="bg-light pb-5 pb-lg-0">
      {/* 1. HERO SECTION WITH DETAILED INTRO */}
      <div className="container-fluid pt-3 pb-5" style={{ backgroundColor: '#f8f9fa' }}>
          ...
          <div className="col-lg-7 mb-5 mb-lg-0">
            <div className="pe-lg-5">
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <Link to="/admission" className="btn btn-primary btn-lg rounded-pill px-5 py-3">
        ...
        <div className="row">
          <div className="col-lg-10 mx-auto">
            <div className="text-center mb-5">
              <h2 className="fw-800 mb-3">A Legacy of Excellence in Computer Education</h2>
            ...
            <div className="modern-card p-2 border-0">
              ...
              <div className="text-center p-4 rounded-3" style={{ backgroundColor: '#f0f7ff' }}>
                ...
                <div className="d-flex flex-wrap gap-3 justify-content-center">
                  <Link to="/contact" className="btn btn-primary rounded-pill px-5 py-3">
