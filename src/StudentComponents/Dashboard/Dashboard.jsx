...
// Note: doc import add kiya gaya hai
...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    // 2. Payments Sub-collection Listen (Real-time)
    const payQ = query(
    ...
    // Cleanup: Dono listeners ko band karna zaroori hai
    return () => {
      unsubStudent();
      unsubPay();
    };
        ...
        <div className="container py-2">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <div className="d-flex align-items-center">
              <div className="position-relative">
                <img 
                  src={data?.photoUrl || `https://ui-avatars.com/api/?name=${user?.email}`} 
          ...
          <div className="bg-white bg-opacity-10 rounded-4 p-3 d-flex align-items-center justify-content-between border border-white border-opacity-10">
            <div>
              ...
              <h5 className="mb-0 text-warning fw-bold">₹{summary?.nextInstallment || "---"}</h5>
            </div>
          ...
          <div className="list-group list-group-flush">
            {payments.length > 0 ? (
                ...
                <div key={p.id} className="list-group-item p-3 d-flex align-items-center justify-content-between border-light">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <button 
                      ...
                      className="btn btn-outline-primary btn-sm rounded-circle p-0" 
              ...
              <div className="p-4 text-center text-muted">
                <small>No payment records found.</small>
              </div>
            )}
          </div>
        </div>
